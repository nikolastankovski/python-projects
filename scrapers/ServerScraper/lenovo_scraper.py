...
SERVERS_URL = f"{BASE_URL}/us/en/servers-storage/servers/#servers"
IS_TEST = False
...
async def get_products():
    ...
    async with async_playwright() as p:
        print("START - get_available_products")
        print("------------------------")
        ...
        for i in range(4):
            ...
            if IS_TEST:
                break
        print("END - get_available_products")        
        await browser.close()
        return pd.DataFrame(servers)

async def get_config_by_product_number(product_number:str):  
    SERVER_CONFIGURATOR_ULR = f"https://www.lenovo.com/us/en/configurator/dcg/index.html?lfo={product_number}"
    ...
    async with async_playwright() as p:
        ...
        try:
            await page.goto(url=SERVER_CONFIGURATOR_ULR)
...
if __name__ == "__main__":
    ...
    #asyncio.run(get_config_by_product_number("7D2XA064NA"))